...
valor_compras_loja = df_compras_filter["preco"].sum()
valor_compras_loja = f"R$ {valor_compras_loja:.2f}"
col1.metric("Valor de compras no período", valor_compras_loja)
...
# Exibe as métricas nas colunas criadas
col1.metric("Valor de compras no período",valor_compras_loja)
col2.metric("Quantidade de compras no período", quantidade_compras_loja)
